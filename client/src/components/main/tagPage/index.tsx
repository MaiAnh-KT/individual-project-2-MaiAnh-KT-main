...
// ./client/src/components/main/tagPage/TagPage.tsx
// import React, { useEffect, useState } from 'react';
// import './index.css';
// import TagView from './tag';
// import { getTagsWithQuestionNumber } from '../../../services/tagService';
...
// const TagPage: React.FC<TagPageProps> = ({ clickTag, handleNewQuestion }) => {
//   const [tlist, setTlist] = useState<TagData[]>([]);
...
//           <TagView
//             key={idx}
//             tagData={{ name: t.name, description: t.description }}
//             clickTag={clickTag}
//           />
//         ))}
//       </div>
